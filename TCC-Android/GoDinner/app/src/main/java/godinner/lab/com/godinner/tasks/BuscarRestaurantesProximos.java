...
public class BuscarRestaurantesProximos extends AsyncTask {
    ...
    public BuscarRestaurantesProximos(Integer idConsumidor, String token, Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            URL url = new URL(String.format("%s/restaurante/destaque/%s", context.getResources().getString(R.string.ipServidor), idConsumidor));
