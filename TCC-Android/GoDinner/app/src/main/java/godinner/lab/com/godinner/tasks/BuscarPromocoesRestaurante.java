...
public class BuscarPromocoesRestaurante extends AsyncTask {
    ...
    public BuscarPromocoesRestaurante(int idRestaurante, String token, Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            URL url = new URL(String.format("%s/produto/promocao/%s", context.getResources().getString(R.string.ipServidor), idRestaurante));
